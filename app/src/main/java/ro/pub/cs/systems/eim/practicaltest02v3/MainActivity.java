...
import ro.pub.cs.systems.eim.practicaltest02v3.network.ClientThread;
import ro.pub.cs.systems.eim.practicaltest02v3.network.ServerThread;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView definitionsView = null;
    ...
    private class GetDefinitionButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            definitionsView.setText(Constants.EMPTY_STRING);

            ClientThread clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), name, definitionsView
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button getDefinitionButton = (Button) findViewById(R.id.get_button);
        getDefinitionButton.setOnClickListener(getDefinitionButtonClickListener);
        definitionsView = findViewById(R.id.result_text_view);


        definitionsView.setTextColor(Color.WHITE);
    }
